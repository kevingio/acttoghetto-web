            ...
            <div class="col-xl-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-sm-10">
                                <h4 class="mt-0 header-title">Master Data Category</h4>
                            </div>
                        ...
                        <div class="table-overflow" id="master-data-category-page">
                            <table id="masterDataCategoryDataTable" class="table table-striped table-bordered dataTable" style="width:100%">
                                <thead>
                                    <tr>
